// ------------------- Defining Study Area (Custom AOI - Umran Basin) ------------------- //

// Option 1: Use predefined basin from HydroSHEDS (for reference or other basins)
// Uncomment and modify if you want to use a known basin like Mahi, Narmada, etc.
/*
var dataset = ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_12");
var mainID = 4120031730; // Example: Mahi Basin MAIN_BAS ID
var main = dataset.filter(ee.Filter.eq('MAIN_BAS', mainID));
var aoi = main;
print('Number of Sub-basins:', main.size());
*/

// Option 2: Use your own study area — Umran Basin (loaded as an imported asset or table)
var aoi = table; // Replace 'table' with your asset name if different

// Visualize the AOI
Map.centerObject(aoi, 10);
Map.addLayer(aoi, {color: 'blue'}, 'Study Area - Umran Basin');
